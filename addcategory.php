          ...
          <div class="row">
            <div class="col-lg-12 mx-auto align-self-center">
              <div class="site-block-cover-content text-center">
                <h1 class="mb-0"><strong class="text-primary">CATEGORY DEATILS</strong> </h1><br>

                <div class="row justify-content-center mb-5">
                  <div class="col-lg-6 text-center">
                  <center>
                   <form action="cataction.php">
                   <table style="color:#060">
                   <tr><td>Category Code</td><td>&nbsp;</td><td><input type="text" name="t1"  required class="btn btn-primary px-5 py-3"></td></tr>
                   <tr><td>&nbsp;</td></tr>
                   <tr><td>Category Name</td><td>&nbsp;</td><td><input type="text" name="t2"  required class="btn btn-primary px-5 py-3"></td></tr>
                   <tr><td>&nbsp;</td></tr>
