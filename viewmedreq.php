          ...
          <div class="row">
            <div class="col-lg-12 mx-auto align-self-center">
              <div class="site-block-cover-content text-center">
                <h1 class="mb-0"><strong class="text-primary">REQUEST DEATILS</strong> </h1><br>
                ...
                <table border="2" style="color:#FFF">
				  ...
				  session_start();
				  $val=$_SESSION['uid'];
				   $q="select * from request where vid='$val'";
				   $rs=$db->selectData($q);
				   while($row=mysql_fetch_array($rs))
				   {
					   ...
					   {
						   ?>
                           <td><a href="rapr.php?id=<?php echo $row['rqid'];?>"><font color="#FFFFFF">Approve</font></a></td>
                            <td><a href="rrej.php?id=<?php echo $row['rqid'];?>"><font color="#FFFFFF">Reject</font></a></td>
                           <?php
					   }
					   ?>
                       </tr>
