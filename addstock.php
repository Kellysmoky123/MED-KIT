          ...
          <div class="row">
            <div class="col-lg-12 mx-auto align-self-center">
              <div class="site-block-cover-content text-center">
                <h1 class="mb-0"><strong class="text-primary">STOCK DEATILS</strong> </h1><br>

                <div class="row justify-content-center mb-5">
                  <div class="col-lg-6 text-center">
                  <center>
                   <form action="stockaction.php">
                   <table style="color:#060">
                   <tr><td>Medicine Name</td><td>&nbsp;</td><td><input type="text" name="t1"  required class="btn btn-primary px-5 py-3"></td></tr>
                   <tr><td>&nbsp;</td></tr>
                   <tr><td>Manufacturing Date</td><td>&nbsp;</td><td><input type="date" name="t2"  required class="btn btn-primary px-5 py-3" min="<?php echo date('Y-m-d');?>"></td></tr>
                   <tr><td>&nbsp;</td></tr>
                   <tr><td>Expire Date</td><td>&nbsp;</td><td><input type="date" name="t3"  required class="btn btn-primary px-5 py-3" min="<?php echo date('Y-m-d');?>"></td></tr>
                   <tr><td>&nbsp;</td></tr>
                   <tr><td>Quantity</td><td>&nbsp;</td><td><input type="text" name="t4"  required class="btn btn-primary px-5 py-3"></td></tr>
                   <tr><td>&nbsp;</td></tr>
