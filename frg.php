            ...
            <div class="col-lg-12 mx-auto align-self-center">
              <div class="site-block-cover-content text-center">
                ...
                <div class="row justify-content-center mb-5">
                  ...
                  <center>
                   <form action="frgaction.php" >
                   <table style="color:#060">
                   <tr><td>Enter Your Email id</td><td>&nbsp;</td><td><input type="text" name="t1"  required class="btn btn-primary px-5 py-3"></td></tr>
                   <tr><td>&nbsp;</td></tr>
                  
                   <tr><td align="center" colspan="2"><input type="submit" value="FORGOT" class="btn btn-primary px-5 py-3"></td></tr> 
