          ...
          <div class="row">
            <div class="col-lg-12 mx-auto align-self-center">
              <div class="site-block-cover-content text-center">
                <h1 class="mb-0"><strong class="text-primary">BRAND DETAILS</strong> </h1>
                ...
                <div class="row justify-content-center mb-5">
                 ...
                 <table border="2" style="color:#FFF">
                  ...
                  <th>Image</th>
				   ...
				   $db=new DatabaseCon;
				  // $id=$_GET['id'];
				   $q="select * from mshop inner join medicine on medicine.vid=mshop.mid";
				   $rs=$db->selectData($q);
				   while($row=mysql_fetch_array($rs))
				   {
                       ...
                       <td><a href="req.php?id=<?php echo $row['mid'];?>"><font color="#FFFFFF">BUY NOW</font></a></td>
                       </tr>
                       <?php
				   }
				   ?>
